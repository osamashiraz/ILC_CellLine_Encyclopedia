...
```
    ...
    ## Installing ICLE Project Dependencies

    ## ==============================================

    ## All CRAN packages already installed.

    ## All Bioconductor packages already installed.
...
```
    ...
    ## STEP 0/8: Cell Line Annotations already loaded (skipping)

    ## STEP 1/8: RPPA data already loaded (skipping)

    ## STEP 2/8: RNA-seq data already loaded (skipping)

    ## STEP 3/8: CNV data already loaded (all required objects present in GlobalEnv)
    ...
    ## STEP 5/8: DNAm data already loaded (skipping)

    ## STEP 6/8: SV data already loaded (skipping)

    ## STEP 7/8: External data already loaded (all required objects present in GlobalEnv)

    ##   ✓ TCGA_Annots: present

    ##   ✓ MSK_Annots: present

    ## STEP 8/8: GAM data already loaded (skipping)
    ...
    ##   ⊚ ANNOTATIONS         : ALREADY_LOADED

    ##   ⊚ RPPA                : ALREADY_LOADED

    ##   ⊚ RNASEQ              : ALREADY_LOADED
...
<img src="md_content/figure-gfm/supfig1_genotype-1.png"/>
...
<img src="md_content/figure-gfm/supfig2a_rna_ht-1.png"/>
...
<img src="md_content/figure-gfm/supfig2b_rna_pca-1.png"/>
...
<img src="md_content/figure-gfm/supfig2c_rna_ims-1.png"/>
...
<img src="md_content/figure-gfm/supfig3a_rppa_ht-1.png"/>
...
<img src="md_content/figure-gfm/supfig3b_rppa_pca-1.png"/>
...
<img src="md_content/figure-gfm/supfig3c_rppa_ims-1.png"/>
...
<img src="md_content/figure-gfm/supfig4a_dnam_ht-1.png"/>
...
<img src="md_content/figure-gfm/supfig4b_dnam_pca-1.png"/>
...
<img src="md_content/figure-gfm/supfig4c_dnam_ims-1.png"/>
...
<img src="md_content/figure-gfm/fig1b_multiomics_sankey-1.png"/>
...
<img src="md_content/figure-gfm/fig1c_set-1.png"/>
...
<img src="md_content/figure-gfm/fig1d_multiomics-1.png"/>
...
```
    ...
    ##   ✓ P-values (numeric) saved: /Users/oshah/Documents/ICLE/3-Results/Molecular_Resemblance/Fig1F_Alteration_Barplot_pval.html

    ##   ✓ P-values (notation) saved: /Users/oshah/Documents/ICLE/3-Results/Molecular_Resemblance/Fig1F_Alteration_Barplot_pval_nt.html
...
<img src="md_content/figure-gfm/fig1f_alterations-1.png"/>
...
<img src="md_content/figure-gfm/supfig5_ilc_nst-1.png"/>
...
<img src="md_content/figure-gfm/supfig6_pathway-1.png"/>
...
<img src="md_content/figure-gfm/fig2c_exonic-1.png"/>
...
<img src="md_content/figure-gfm/fig2d_fmi-1.png"/>
...
<img src="md_content/figure-gfm/fig2f_cdh1_af-1.png"/>
...
<img src="md_content/figure-gfm/fig2g_allele_freq-1.png"/>
...
<img src="md_content/figure-gfm/fig2h_landscape-1.png"/>

``` r
draw(fig2h_cl, merge_legends = TRUE)
```

<img src="md_content/figure-gfm/fig2h_landscape-2.png"/>
...
<img src="md_content/figure-gfm/fig3a_left-1.png"/>
...
<img src="md_content/figure-gfm/fig3a_right-1.png"/>
...
<img src="md_content/figure-gfm/fig3b-1.png"/>
...
<img src="md_content/figure-gfm/fig3c-1.png"/>
...
<img src="md_content/figure-gfm/fig3e_fusions-1.png"/>
...
<img src="md_content/figure-gfm/fig3f_circos_functional_fusions_GOE-1.png"/>
...
<img src="md_content/figure-gfm/fig3f_circos_functional_fusions_LOE-1.png"/>
...
<img src="md_content/figure-gfm/supfig8a-1.png"/>
...
<img src="md_content/figure-gfm/supfig8b-1.png"/>
...
<img src="md_content/figure-gfm/supfig8c-1.png"/>
...
<img src="md_content/figure-gfm/supfig8d-1.png"/>
...
<img src="md_content/figure-gfm/supfig10-1.png"/>
...
<img src="md_content/figure-gfm/supfig10B_recurring_functional_fusions-1.png"/>
...
<img src="md_content/figure-gfm/supfig11a_tumor_pam50-1.png"/>
...
<img src="md_content/figure-gfm/supfig11b_cl_pam50-1.png"/>
...
<img src="md_content/figure-gfm/supfig11c_tumor_cl_histology-1.png"/>
...
<img src="md_content/figure-gfm/fig4a-1.png"/>
...
<img src="md_content/figure-gfm/fig4b-1.png"/>
...
<img src="md_content/figure-gfm/fig4c-1.png"/>
...
<img src="md_content/figure-gfm/fig4d-1.png"/>
...
<img src="md_content/figure-gfm/fig5b_display-1.png"/>
...
<img src="md_content/figure-gfm/supfig12-1.png"/>
...
<img src="md_content/figure-gfm/fig5c-1.png"/>
...
<img src="md_content/figure-gfm/fig5d-1.png"/>
...
<img src="md_content/figure-gfm/fig5e-1.png"/>
...
<img src="md_content/figure-gfm/fig6_display-1.png"/>
...
```
    ...
    ##  [1] msigdbr_25.1.1              hypeR_2.0.0                 tidytext_0.4.3             
    ##  [4] patchwork_1.3.2             sesame_1.26.0               sesameData_1.26.0          
    ##  [7] ExperimentHub_2.16.1        AnnotationHub_3.16.1        BiocFileCache_2.16.2       
    ## [10] dbplyr_2.5.1                limma_3.64.3                DESeq2_1.48.2              
    ## [13] webshot2_0.1.2              htmlwidgets_1.6.4           interacCircos_1.18.0       
    ## [16] hiAnnotator_1.42.0          gridExtra_2.3               ShatterSeek_1.1            
    ## [19] graph_1.86.0                foreach_1.5.2               scales_1.4.0               
    ## [22] ggsci_4.1.0                 gt_1.1.0                    ggpattern_1.2.1            
    ## [25] clusterProfiler_4.16.0      org.Hs.eg.db_3.21.0         AnnotationDbi_1.70.0       
    ## [28] CancerSubtypes_1.17.1       NMF_0.28                    cluster_2.1.8.1            
    ## [31] rngtools_1.5.2              registry_0.5-1              sigclust_1.1.0.1           
    ## [34] tidyr_1.3.1                 forcats_1.0.1               circlize_0.4.16            
    ## [37] ConsensusClusterPlus_1.72.0 SummarizedExperiment_1.38.1 MatrixGenerics_1.20.0      
    ## [40] matrixStats_1.5.0           BreastSubtypeR_1.0.0        viridis_0.6.5              
    ## [43] viridisLite_0.4.2           data.table_1.17.8           readxl_1.4.5               
    ## [46] maftools_2.24.0             stringr_1.5.2               ggrepel_0.9.6              
    ## [49] rtracklayer_1.68.0          GenomicRanges_1.60.0        GenomeInfoDb_1.44.3        
    ## [52] IRanges_2.42.0              S4Vectors_0.46.0            magrittr_2.0.4             
    ## [55] DNAcopy_1.82.0              vroom_1.6.6                 reshape2_1.4.4             
    ## [58] ggsankey_0.0.99999          dplyr_1.1.4                 ComplexHeatmap_2.24.1      
    ## [61] ggthemes_5.1.0              ggpubr_0.6.2                ggplot2_4.0.0              
    ## [64] Biobase_2.68.0              BiocGenerics_0.54.1         generics_0.1.4             
    ## 
    ## loaded via a namespace (and not attached):
    ##   [1] R.methodsS3_1.8.2        dichromat_2.0-0.1        Biostrings_2.76.0        vctrs_0.6.5             
    ##   [5] ggtangle_0.0.7           digest_0.6.37            png_0.1-8                shape_1.4.6.1           
    ##   [9] proxy_0.4-27             magick_2.9.0             MASS_7.3-65              httpuv_1.6.16           
    ##  [13] qvalue_2.40.0            withr_3.0.2              xfun_0.53                ggfun_0.2.0             
    ##  [17] ellipsis_0.3.2           survival_3.8-3           memoise_2.0.1            ggbeeswarm_0.7.2        
    ##  [21] gson_0.1.0               systemfonts_1.3.1        ragg_1.5.0               tidytree_0.4.6          
    ##  [25] GlobalOptions_0.1.2      R.oo_1.27.1              Formula_1.2-5            KEGGREST_1.48.1         
    ##  [29] promises_1.4.0           otel_0.2.0               httr_1.4.7               rstatix_0.7.3           
    ##  [33] restfulr_0.0.16          ps_1.9.1                 rstudioapi_0.17.1        units_1.0-0             
    ##  [37] UCSC.utils_1.4.0         DOSE_4.2.0               processx_3.8.6           babelgene_22.9          
    ##  [41] curl_7.0.0               polyclip_1.10-7          GenomeInfoDbData_1.2.14  SparseArray_1.8.1       
    ##  [45] xtable_1.8-4             doParallel_1.0.17        reactable_0.4.4          evaluate_1.0.5          
    ##  [49] S4Arrays_1.8.1           preprocessCore_1.70.0    hms_1.1.4                visNetwork_2.1.4        
    ##  [53] colorspace_2.1-2         filelock_1.0.3           CNTools_1.64.0           readr_2.1.5             
    ##  [57] later_1.4.4              ggtree_3.16.3            lattice_0.22-7           genefilter_1.90.0       
    ##  [61] XML_3.99-0.19            cowplot_1.2.0            class_7.3-23             pillar_1.11.1           
    ##  [65] nlme_3.1-168             iterators_1.0.14         gridBase_0.4-7           compiler_4.5.1          
    ##  [69] stringi_1.8.7            sf_1.0-21                tokenizers_0.3.0         devtools_2.4.6          
    ...
    ##  [81] chromote_0.5.1           fastmatch_1.1-6          codetools_0.2-20         textshaping_1.0.4       
    ##  [85] e1071_1.7-16             GetoptLong_1.0.5         mime_0.13                splines_4.5.1           
    ##  [89] Rcpp_1.1.0               iCluster_2.1.0           cellranger_1.1.0         knitr_1.51              
    ##  [93] blob_1.2.4               clue_0.3-66              BiocVersion_3.21.1       fs_1.6.6                
    ##  [97] pkgbuild_1.4.8           openxlsx_4.2.8           ggsignif_0.6.4           ggplotify_0.1.3         
    ## [101] tibble_3.3.0             Matrix_1.7-4             statmod_1.5.1            tzdb_0.5.0              
    ## [105] svglite_2.2.2            pheatmap_1.0.13          tweenr_2.0.3             pkgconfig_2.0.3         
    ## [109] cachem_1.1.0             RSQLite_2.4.3            DBI_1.2.3                impute_1.82.0           
    ## [113] fastmap_1.2.0            rmarkdown_2.30           usethis_3.2.1            Rsamtools_2.24.1        
    ## [117] sass_0.4.10              broom_1.0.10             BiocManager_1.30.26      carData_3.0-5           
    ## [121] farver_2.1.2             mgcv_1.9-3               yaml_2.3.10              cli_3.6.5               
    ## [125] purrr_1.1.0              lifecycle_1.0.4          sessioninfo_1.2.3        backports_1.5.0         
    ## [129] BiocParallel_1.42.2      annotate_1.86.1          gtable_0.3.6             rjson_0.2.23            
    ## [133] parallel_4.5.1           ape_5.8-1                SnowballC_0.7.1          jsonlite_2.0.0          
    ## [137] edgeR_4.6.3              bitops_1.0-9             kableExtra_1.4.0         bit64_4.6.0-1           
    ## [141] assertthat_0.2.1         yulab.utils_0.2.1        zip_2.3.3                janeaustenr_1.0.0       
    ## [145] GOSemSim_2.34.0          R.utils_2.13.0           lazyeval_0.2.2           shiny_1.11.1            
    ## [149] htmltools_0.5.8.1        enrichplot_1.28.4        GO.db_3.21.0             rappdirs_0.3.3          
    ## [153] glue_1.8.0               XVector_0.48.0           RCurl_1.98-1.17          treeio_1.32.0           
    ## [157] classInt_0.4-11          BSgenome_1.76.0          EnvStats_3.1.0           igraph_2.2.1            
    ## [161] R6_2.6.1                 sva_3.56.0               labeling_0.4.3           pkgload_1.4.1           
    ## [165] aplot_0.2.9              DelayedArray_0.34.1      tidyselect_1.2.1         vipor_0.4.7             
    ## [169] ggforce_0.5.0            xml2_1.4.1               car_3.1-3                wheatmap_0.2.0          
    ## [173] KernSmooth_2.23-26       S7_0.2.0                 gridpattern_1.3.1        websocket_1.4.4         
    ## [177] fgsea_1.34.2             RColorBrewer_1.1-3       rlang_1.1.6              remotes_2.5.0           
    ## [181] Cairo_1.7-0              beeswarm_0.4.0
